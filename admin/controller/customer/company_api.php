<?php
class ControllerCustomerCompanyApi extends Controller{
    ...
    //         'href' => $this->url->link('customer/company_api')
    //     ];
    ...
    public function eik(){
        ...
        if (!$json) {
            ...
            $this->load->model('customer/company_api');
                $json = $this->model_customer_company_api->getCompanyFromApi($eik);
                $result = $this->model_customer_company_api->getCompanyFromApi($eik);
